...
const { scoreRequestQueue, costResponseQueue, fetchCostRequestMsgType } = require('../../../../../app/config/messaging.js')
...
describe('application messaging tests', () => {
  ...
  test('getApplication sends and receives message', async () => {
    ...
    expect(sendMessage).toHaveBeenCalledWith({}, fetchCostRequestMsgType, scoreRequestQueue, { sessionId })
  })
})
